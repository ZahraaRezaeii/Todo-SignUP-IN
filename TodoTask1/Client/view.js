class View {
    constructor() {
      ...
      //this.userName = this.getElementbyId('username');
  ...
  bindUploadTodo(handler) {
    const button = this.getElementbyId("uploadBtn");
  ...
  bindDownloadTodo(handler) {
    const button = this.getElementbyId("downloadBtn");
    button.addEventListener('click', event => {
      handler();
    })
  }
//   showName(fName, lName, uName){
//     this.name.innerHTML = fName +" "+lName;
